...
# s0 = x; s1 = x_max; s2 = y; s3 = y_max; s4 = i (contador)
.globl draw_grid
draw_grid:
...
# s0 = x; s1 = x_max; s2 = y; s3 = y_max; s4 = i
...
set_pixel:
   ...
   mul $a1, $a1, FB_XRES	#a1 = a1 x 256
   add $a0, $a0, $a1		
   sll $a0, $a0, 2		#a0 = a0*4 -> a0 = a1
   add $a0, $a0, $t0		#a0 = a0 + FB_PTR
   sw  $a2, ($a0)		#armazena em a2, a cor no endereço a0
   jr  $ra
#---------------------------------------------------------------------------------------------------------------------#
